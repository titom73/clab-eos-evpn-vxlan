...
| Loopback100 | PRJ01_APP01_VTEP_DIAGNOSTICS | PRJ01_APP01 | 10.255.1.5/32 |
...
| 10.255.251.5 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | PRJ01_APP01 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
...
| --- | ------------------- | ------------ |
| PRJ01_APP01 | 192.0.255.5:10 | connected |
...
| -------------- | --------------------- |
| PRJ01_APP01 | 10.255.1.5 |

### Virtual Source NAT Configuration

```eos
!
ip address virtual source-nat vrf PRJ01_APP01 address 10.255.1.5
```
